...
`, { mode: 0o600 })
  ...
  ok('Setup complete.')
  log('')
  warn('  Want 24/7 hands-off sorting?')
  log('  This local build sorts on demand, while the app is running. For always-on,')
  log('  real-time sorting with nothing to run or maintain, use the hosted version:')
  log('')
  log(`      ${c.cyan}https://viltreon.com${c.reset}`)
  log('')
